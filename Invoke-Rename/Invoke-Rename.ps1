...
.DESCRIPTION
    ...
    A single number in the case there are multiple builds per customer per month. 
    Put all together an example would be DT-2001-1 or NB-2002-4
    ...
    two scripts create a log file and also help determine if a computer is a Desktop, Laptop or NUC
